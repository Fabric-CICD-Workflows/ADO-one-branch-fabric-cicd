...
To get the Azure Dev Ops piplines with CI/CD workflow logic working correctly in an Azure Dev Ops project, you will need to add the following variables and secret to your project in a variable library and make that library accessible to the pipelines.
